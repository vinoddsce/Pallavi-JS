...
//Array - is group of elements and are reffered by same name and with different index position. 
var a = [1, 2, 3, 4, 5];
// console.log(a[0]);
// console.log(a[1]);
...
// var display = function (value, index) {
...
if (ageJohn < ageMark) {
    console.log('ageJohn is lessthan to ageMark');
} else {
    console.log('ageJohn is NOT lessthan to ageMark');
}
